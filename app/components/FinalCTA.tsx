      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-white rounded-2xl p-12 shadow-sm border border-[#dee2e6]">
          ...
          <p className="text-lg text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
            Join thousands of satisfied members who are already enjoying exclusive hotel benefits, significant savings,
            and VIP treatment at luxury destinations worldwide.
          </p>
